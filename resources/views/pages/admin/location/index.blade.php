                ...
                <tbody>
                    @forelse ($locations as $index => $location)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary mr-2" onclick="openEditModal(this)" data-id="{{ $location->id }}" data-nama="{{ $location->location_name }}">Edit</button>
    ...
    <dialog id="add_modal" class="modal">
        <form method="POST" action="{{ route('admin.locations.store') }}" class="modal-box">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama lokasi" class="input input-bordered w-full" name="name" required />
            </div>
     ...
     <dialog id="edit_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama lokasi" class="input input-bordered w-full" value="lokasi Contoh" id="edit_category_name" name="name" />
            </div>
            <div class="modal-action">
                <button class="btn btn-primary" type="submit">Simpan</button>
