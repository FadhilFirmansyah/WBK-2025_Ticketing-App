                ...
                <tbody>
                    @forelse ($payment_types as $index => $payment_type)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary mr-2" onclick="openEditModal(this)" data-id="{{ $payment_type->id }}" data-nama="{{ $payment_type->name }}">Edit</button>
                                <button class="btn btn-sm bg-red-500 text-white" onclick="openDeleteModal(this)" data-id="{{ $payment_type->id }}">Hapus</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
    ...
    <dialog id="add_modal" class="modal">
        <form method="POST" action="{{ route('admin.payment-types.store') }}" class="modal-box">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama tipe pembayaran" class="input input-bordered w-full" name="name" required />
            </div>
     ...
     <dialog id="edit_modal" class="modal">
        <form method="POST" class="modal-box">
            ...
            <div class="form-control w-full mb-4">
                ...
                <input type="text" placeholder="Masukkan nama tipe pembayaran" class="input input-bordered w-full" value="Tipe Pembayaran Contoh" id="edit_category_name" name="name" />
            </div>
            <div class="modal-action">
                <button class="btn btn-primary" type="submit">Simpan</button>
